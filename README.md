...
- 最新状況は README より [docs/specification.md](docs/specification.md) と [docs/status.md](docs/status.md) を優先してください。
...
- 作業状況: [docs/status.md](docs/status.md)
...
Gradle の一時ファイルは `D:\temp` 優先で運用する前提です。詳細は [docs/specification.md](docs/specification.md) を参照してください。
